...
rm -f "Templaters.java"
##################################################
echo "/* WARNING! This file is autogenerated by a script. */"     >> "Templaters.java"
echo "package org.bakasoft.framboyan.templaters;"                 >> "Templaters.java"
echo ""                                                           >> "Templaters.java"
echo "public interface Templaters {"                              >> "Templaters.java"
echo ""                                                           >> "Templaters.java"
##################################################
...
echo ""                                                                                                 >> $R_FILE
echo "import org.bakasoft.framboyan.exceptions.MissingTestException;"                                   >> $R_FILE
...
echo "				throw new MissingTestException();"                                                  >> $R_FILE
echo "			}"                                                                                      >> $R_FILE
echo ""                                                                                                 >> $R_FILE
...
echo "    default <${RG}, ${TG}> ${R_NAME}<${RG}, ${TG}> templater(${B_NAME}<${RG}, ${TG}> builder) {"  >> "Templaters.java"
echo "        return new ${R_NAME}<>(builder);"                                                         >> "Templaters.java"
echo "    }"                                                                                            >> "Templaters.java"
echo ""                                                                                                 >> "Templaters.java"
##################################################
done
