...
public class Templater4x4<T1, T2, T3, T4, U1, U2, U3, U4> {

	private final Templater4x4Builder<T1, T2, T3, T4, U1, U2, U3, U4> builder;

	public Templater4x4(Templater4x4Builder<T1, T2, T3, T4, U1, U2, U3, U4> builder) {
