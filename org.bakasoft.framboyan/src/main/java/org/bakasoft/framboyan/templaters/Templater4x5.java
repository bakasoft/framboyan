...
public class Templater4x5<T1, T2, T3, T4, U1, U2, U3, U4, U5> {

	private final Templater4x5Builder<T1, T2, T3, T4, U1, U2, U3, U4, U5> builder;

	public Templater4x5(Templater4x5Builder<T1, T2, T3, T4, U1, U2, U3, U4, U5> builder) {
