...
public class Templater5x3<T1, T2, T3, T4, T5, U1, U2, U3> {

	private final Templater5x3Builder<T1, T2, T3, T4, T5, U1, U2, U3> builder;

	public Templater5x3(Templater5x3Builder<T1, T2, T3, T4, T5, U1, U2, U3> builder) {
